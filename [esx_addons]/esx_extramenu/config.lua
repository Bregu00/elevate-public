...
Config.PoliceDatabaseName     = {['police'] = true} -- set the exact name from your jobs database for police
...
Config.PoliceHelicopters      = {
	{ model = 'HELIP', label = 'Politi Maverick', livery = 0, price = 0 }
}

-- Police Boats:
Config.PoliceBoats            = {
	{ model = 'poldinghy', label = 'Politi Dinghy', livery = 0, price = 0 }
}
...
Config.ExtraZones = {
	{ x = 871.2703, y = -1350.216, z = 25.64367 }, -- La mesa
	{ x = 449.80, y = -972.65, z = 24.71 }, -- MRPD
}
Config.Colors                 = {
