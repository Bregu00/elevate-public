...
function lib.logger(source, event, message, ...)
    local src = ESX.GetPlayerFromIdentifier(source).source
    exports.onl_logsender:SendLog(src, message, {
        ...
        discordWebhook = "https://discord.com/api/webhooks/1343563249135652864/jrGurmAFWYzB7Q-YejssZ-OWG--dSv2u9oE2UhR9wfQ_vt21hxMHqKpSSVl8hRia2MOP?thread_id=1343563181209030696"
    })
end
