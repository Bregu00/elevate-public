...
print("^2"..(usingOX and "ox_inventory" or usingQS and "qs-inventory" or usingOrigen and "origen_inventory" or usingCodem and "codem-inventory") or "Default AddItem".."^7")
    ...
    if Config.StarterItems and next(Config.StarterItems) then
        ...
        for i = 1, #Config.StarterItems do
            ...
            if not added and usingQS then
                exports['qs-inventory']:AddItem(source, item.name, item.amount, metadata)
                added = true
            end
