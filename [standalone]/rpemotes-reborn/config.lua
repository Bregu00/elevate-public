Config = {
    -- Menu Options
    MenuLanguage = 'da', -- Change the language of the menu here!.
    ...
    CancelEmoteKey = 'z', -- Get the button string here https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
