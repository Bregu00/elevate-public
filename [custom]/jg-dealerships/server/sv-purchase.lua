...
-- Send webhook using SendLog export
local vehicleId = Framework.Server.SaveVehicleToGarage(src, purchaseType, society, societyType, model, plate, financed, financeData, dealershipData)

-- ONL_LOGSENDER PIK I RØVEN ELLERS GÅR JEG AMOK
exports.onl_logsender:SendLog(src, "New Vehicle Purchase - Model: " .. model .. " - Price: DKK" .. amountToPay, {
    labels = {
        job = "logs",
        discordId = true,
        steamId = true,
    ...
    discordTitle = "New Vehicle Purchase",
    discordWebhook = "https://discord.com/api/webhooks/1338009720857821184/TfwOCOmTs8xBHiQ42beLHJXfU07c2h1aylDy6Z5bm4tzTPDOk1SOhCC0K8QNhLEJNyQZ?thread_id=1338009534349705237", -- Webhooks.Purchase
    discordColor = 0x2ecc71, -- Green for "success"
    discordFields = {
        { name = "Player", value = "```" .. GetPlayerName(src) .. " (id: " .. src .. ")```", inline = false },
        { name = "Vehicle", value = "```" .. model .. "```", inline = true },
        { name = "Plate", value = "```" .. plate .. "```", inline = true },
        { name = "Financed", value = "```" .. (financed and "Yes" or "No") .. "```", inline = true },
        { name = "Amount Paid", value = "```$" .. amountToPay .. "```", inline = true },
        { name = "Payment method", value = "```" .. paymentMethod .. "```", inline = true },
        { name = "Dealership", value = "```" .. dealershipId .. "```", inline = true },
        { name = "Seller Name", value = "```" .. (sellerPlayerName or "-") .. "```", inline = true }
    }
})
