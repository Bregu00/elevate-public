...
if Framework == 'esx' then
    ...
    RegisterNetEvent('esx:playerLoaded', function(xPlayer)
        ...
        TriggerEvent('bn_bridge:onPlayerLoaded')
        PlayerLoaded = true
    end)
...
RegisterNetEvent('bn_lib:createLog', function(name, title, color, message, tagEveryone)
    ...
    BN.Log(name, title, color, message, tagEveryone)
end)