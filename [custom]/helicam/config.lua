...
Config.Localisation = {
    -- Notifications
    Notification = {
        JobNotWhitelisted = "Du har ikke den kr vende job!",
        JobGrade = "Din jobgrad er for lav!",
        NoCameraHeli = "Denne helikopter har ikke en kamera!",
        NoCameraPlane = "Dette fly har ikke en kamera!",
        IsPilot = "Du kan ikke bruge kameraet mens du er pilot!",
        NotInRear = "Du skal være i bagsiden af helikopteren for at bruge kameraet!",
        CameraInUse = "Nogen anden bruger allerede kameraet!",
        SpotlightInUse = "Nogen anden bruger allerede kameraets lys!",
        NoSpotlight = "Denne helikopter har ikke et lys!",
        SpotlightGlobalLimit = "Det globale lyslimit er nået!",
        CannotRappelFromHeli = "Denne helikopter underst tter ikke rappelling!",
        CannotRappelFromSeat = "Du kan ikke rappelle fra denne plads!",
        ToHighToRappel = "Helikopteren er for høj til at rappelle!",
        ConfirmRappel = "Er du sikker på du vil rappelle? (Tryk igen for at bekræfte)",
        Rappelling = "Rappellerer!"
    },
    -- Blip Names
    Blip = {
        Target = "Helikam Target",
        Marker = "Helikam Marker"
    },
    -- Keybinding Descriptions
    KeyMapping = {
        ToggleCam = "Helikam - Slå kameraet til/fra",
        AttemptLock = "Helikam - Forsøg at låse",
        CycleVision = "Helikam - Cyklere synet",
        ToggleMarker = "Helikam - Tilføj/ fjern mark rer",
        Rappel = "Helikam - Rappel fra helikopteren",
        Spotlight = "Helikam - Slå lys til/fra",
        SpotlightBrightness = "Helikam - (+ scroll) Juster lysstyrken",
        SpotlightRadius = "Helikam - (+ scroll) Juster lysradius",
        Postals = "Helikam - Slå postnumre til/fra"
    },
    ChatSuggestions = {
        ToggleCamera = "Gå ind/ud af helikopterkameraet",
        Rappel = "Rappel fra helikopteren"
    }
}
