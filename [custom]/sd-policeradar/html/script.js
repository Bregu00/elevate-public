...
const patrolId = document.getElementById("patrol-id")
...
function applyPatrolId(patrolId) {
  document.getElementById("patrol-id").textContent = patrolId
}
...
window.addEventListener("message", (event) => {
  ...
  } else if (data.type === "updatePatrolId") {
    applyPatrolId(data.patrolId)
  }
})