Config.contracts.laundromat = {
    ...
    settings = {
        ...
        minMembers = 2,
        -- maxMembers = 6,
        rewards = { crypto = 9, experience = 200 }, -- Other rewards such as items are listed below
        minPolice = 4
    },
    ...
    loot = {
        ...
        items = {
            { name = 'coins', count = { min = 19, max = 23 } }
        },
        locations = {
    ...
    office = {
        ...
        safe = {
            ...
            rewards = {
                { item = 'black_money', count = { min = 145000, max = 225000 } },
            }
        }
    }
}