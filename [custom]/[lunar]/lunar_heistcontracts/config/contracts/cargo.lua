Config.contracts.cargo = {
    ...
    settings = {
        ...
        minMembers = 2,
        -- maxMembers = 5,
        rewards = { crypto = 5, experience = 75 }, -- Other rewards such as items are listed below
        minPolice = 2
    },
    ...
    loot = {
        count = { min = 4, max = 5 }, -- 3-4 of the provided locations are filled with loot
        progressDuration = 7500, -- progress bar duration
        types = {
            {
                itemCount = 2, -- 2 of the items below get randomly selected
                ...
                items = {
                    { name = 'ammo',            count = { min = 65,         max = 110 } },
                    { name = 'black_money',     count = { min = 45000,      max = 85000 } },
                    { name = 'luxurious_watch', count = { min = 8,          max = 12 } },
                    { name = 'gold_bar',        count = { min = 6,          max = 10 } },
                    { name = 'ring',            count = { min = 7,          max = 13 } },
                    { name = 'thermite',        count = { min = 1,          max = 1 } },
                    { name = 'ammo',            count = { min = 65,         max = 110 } },
                    { name = 'black_money',     count = { min = 45000,      max = 85000 } },
                    { name = 'luxurious_watch', count = { min = 8,          max = 12 } },
                    { name = 'gold_bar',        count = { min = 6,          max = 10 } },
                    { name = 'ring',            count = { min = 7,          max = 13 } },
                    { name = 'thermite',        count = { min = 1,          max = 1 } },
                    { name = 'landmine',        count = { min = 1,          max = 1 } },
                }
            }
        }
    }
