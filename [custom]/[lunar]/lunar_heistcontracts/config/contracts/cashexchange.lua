Config.contracts.cashexchange = {
    ...
    settings = {
        ...
        minMembers = 2,
        -- maxMembers = 6,
        rewards = { crypto = 9, experience = 150 }, -- Other rewards such as items are listed below
        minPolice = 2
    },
    ...
    unlockVault = {
        ...
        removeAfterUse = false,
        delay = 1 -- The vault will unlock in 2 minutes
    },
    ...
    locations = {
        {
            ...
            loot = {
                rewards = {
                    ['cash'] = { account = 'black_money', count = { pile = 300000, trolley = 275000 } },
                },
                goldChance = 0,
                locations = {
                    {
