Config.contracts.mazebank = {
    ...
    settings = {
        ...
        minMembers = 4,
        -- maxMembers = 16,
        rewards = { crypto = 45, experience = 500 },
        minPolice = 5
    },
    ...
    alarm = {
        ...
        duration = 60, -- seconds
        silentDelay = 1 -- minutes after the main vault door is opened
    },
    ...
    miniSafe = {
        ...
        rewards = {
            { item = 'black_money', count = { min = 165000, max = 190000 } },
        },
        locations = {
    ...
    basement = {
        ...
        loot = {
            rewards = {
                ['cash'] = { item = 'black_money',  count = { pile = 300000,    trolley = 350000 } },
                ['gold'] = { item = 'gold_bar',     count = { pile = 60,        trolley = 110 } },
            },
            goldChance = 60,
            locations = {
                -- Sidevault 1
