Config.contracts.artasylum = {
    ...
    -- police can cancel heist on the reception if enabled in config
    cancelPoint = vector3(118.1147, -146.4781, 54.7990),
    ...
    safe = {
        ...
        rewards = {
            { account = 'money', count = { min = 22000, max = 44000 } },
            { item = 'rare_coins', count = { min = 2, max = 3 }, chance = 50 },
            { item = 'luxurious_watch', count = { min = 4, max = 12 }, chance = 50 },
            { item = 'WEAPON_PISTOL50', count = 1, chance = 30 }
        }
    },
    ...
    vault = {
        ...
        loot = {
            rewards = {
                ['cash'] = { account = 'money', count = { pile = 82000, trolley = 120000 } },
