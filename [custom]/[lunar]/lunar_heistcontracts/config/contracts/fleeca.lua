Config.contracts.fleeca = {
    ...
    settings = {
        ...
        minMembers = 3,
        -- maxMembers = 8,
        rewards = { crypto = 15, experience = 300 }, -- Other rewards such as items are listed below
        minPolice = 4
    },
    ...
    loot = {
        rewards = {
            ['cash'] = { item = 'black_money',  count = { pile = 250000,    trolley = 300000 } },
            ['gold'] = { item = 'gold_bar',     count = { pile = 60,        trolley = 100 } },
        },
        goldChance = 40,
        locations = {
            {
    ...
    drilling = {
        ...
        -- Supports metadata
        rewards = {
            { item = 'black_money', count = { min = 525000,     max = 575000 } },
            { item = 'large_drill', count = { min = 1,          max = 1 }, chance = 25 },
        },
        locations = {
