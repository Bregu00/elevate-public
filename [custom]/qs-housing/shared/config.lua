...
Config.FiveGuard = 'av_blackmarket' -- Your fiveguard script name if exists, if not false.
...
Config.SocietyCommision = 0.10  -- Percentage of the commission for the company (%30 of house price)

-- Taxes configuration
Config.BankFee = function(price) return 0 end
Config.BrokerFee = function(price) return 0 end
Config.Taxes = function(price) return 0 end
...
Config.MaxOwnedHouses = 100           -- Limit of houses per player (5 default)
...
Config.MaxVaultCodes = 1              -- Select the number of vaults that each home can have


-- Your currency symbol (https://www.telerik.com/blogs/javascript-intl-object)
Config.Intl = {
	locales = 'da-DK',      -- 'en-US', 'pt-BR', 'es-ES', 'fr-FR', 'de-DE', 'ru-RU', 'zh-CN'
	options = {
		style = 'currency', -- 'decimal', 'currency', 'percent', 'unit'
		currency = 'DKK',   -- 'USD', 'EUR', 'BRL', 'RUB', 'CNY'
...
Config.CreditEnable = false                     -- Enable or disable the mortgage option in the house contract.
...
Config.EnableRentable = false                   -- Enable or disable the rental system
...
Config.DecorateOnlyAccessForOwner = false -- Can anyone with a key decorate or only the owner?
...
Config.DoorDistance = 2.0                  -- Distance to interact with doors
...
Config.Debug = false      -- Enable or disable debug mode for general information and troubleshooting.
