return {
    ...
    timeBetweenRain = 20000, -- How many minutes between rain events
    rainAfterRestart = 20000, -- How many minutes AFTER a server restart before rain will start to show?
