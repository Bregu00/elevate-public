...
Config.cosmetics = { -- Only remove options and change options values, don't add any and don't change the value!
    ...
    { label = 'Livery mod', value = 48, modsId = 'modLivery', item = 'cosmetics' },
    { label = 'Lightbar', value = 49, modsId = 'modLightbar', item = 'cosmetics' },
    { label = 'Livery', value = 'livery', modsId = 'modLivery', item = 'cosmetics' },
...
Config.xenonColors = {
    { value = 0, rgb = "rgb(255, 255, 255)" }, -- White
    { value = 1, rgb = "rgb(2, 21, 255)" }, -- Blue
    { value = 2, rgb = "rgb(3, 83, 255)" }, -- Electric Blue
    { value = 3, rgb = "rgb(0, 255, 140)" }, -- Mint Green
    { value = 4, rgb = "rgb(94, 255, 1)" }, -- Lime Green
    { value = 5, rgb = "rgb(255, 255, 0)" }, -- Yellow
    { value = 6, rgb = "rgb(255, 150, 0)" }, -- Golden Shower
    { value = 7, rgb = "rgb(255, 62, 0)" }, -- Orange
    { value = 8, rgb = "rgb(255, 0, 0)" }, -- Red
    { value = 9, rgb = "rgb(255, 50, 100)" }, -- Pony Pink
    { value = 10, rgb = "rgb(255, 5, 190)" }, -- Hot Pink
    { value = 11, rgb = "rgb(35, 1, 255)" }, -- Purple
    { value = 12, rgb = "rgb(15, 3, 255)" } -- Blacklight
}