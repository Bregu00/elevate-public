...
Config.framework = 'esx' -- qb, qbx, esx (need to change the export on the Config.core)
Config.core = exports.es_extended:getSharedObject() -- core export (for qb is exports['qb-core']:GetCoreObject()) (for esx is exports.es_extended:getSharedObject()) (for qbx you can just delete this line and add '@qbx_core/modules/playerdata.lua', to the fxmanifest.lua client_scripts)
...
Config.keys = 'custom' -- qb-vehiclekesy, Renewed-Vehiclekeys, qbx_vehiclekeys, ... (can change at server/functions.lua)
Config.banking = 'custom' -- qb-banking, Renewed-Banking, ... (can change at server/functions.lua)

Config.locale = 'da' -- this is the locales that'll show on the script UI
...
Config.repairItems = {
    engine = { count = 0, item = 'money' },
    body = { count = 0, item = 'money' },
    tank = { count = 0, item = 'money' },
}
