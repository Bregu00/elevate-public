...
Config.App = {
    ...
    label = "Cupcake Swap",
    isEnabled = function()
        print(LocalPlayer.state.isAccountLocked)
        if LocalPlayer.state.isAccountLocked then return false end
...
Config.AvailableCryptos = {
    {
        name = "Crypto",          -- How your account is named in your framework
        label = "CRPTO",          -- How the player will see the account in app, max 4 characters
        buy = 50000,                -- Price 1x crypto = 20 of buyAccount money
        sell = 25000,               -- Price 1x crypto = 15 of buyAccount money
