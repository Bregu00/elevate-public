...
Config.Framework                            = "esx"              -- "autodetect" or "qbcore" or "qbox" or "esx"
Config.Inventory                            = "ox_inventory"              -- "autodetect" or "ox_inventory" or "qs-inventory" or "ps-inventory" or "lj-inventory" or "codem-inventory" or "core_inventory"

Config.DefaultDarkMode                      = 1                         -- Whether dark mode should be enabled by default. 1 is on by default, 0 is off

Config.ServerName                           = "ELEVATE"
Config.ServerDiscord                        = "https://discord.gg/elevaterp"                        -- For kick/ban messages
...
Config.ESXUseAcePerms                       = false                      -- ESX ONLY - Whether to use Ace Perms for permissions (new) or ESX "group" (old)
...
Config.ThirdParty.Clothing = function(player) -- This is a server function
    ...
    TriggerClientEvent('rcore_clothing:openAdminClothing', player)
...
Config.ThirdParty.GiveVehicleKeys = function(vehicleId) -- This is a client function and only applies to QBCore and ESX - not used for QBox
    -- This is for QBCore
...
Config.ThirdParty.Revive = function(targetId) -- This is a server function
    ...
    TriggerClientEvent('ars_ambulancejob:healPlayer', targetId, data)
