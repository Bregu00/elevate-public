...
AdminPanel.Open = function(data) {
    ...
    $("#jobboss, #relieveStress, #setGangButton, #gangpagebtn, #savePlayer, #setWeatherButton, #setTimeButton").show();
    if (AdminPanel.Framework == "esx" || AdminPanel.Framework == "ESX") {
        $("#jobboss, #relieveStress, #setGangButton, #gangpagebtn, #savePlayer, #setWeatherButton, #setTimeButton").hide();
    }
