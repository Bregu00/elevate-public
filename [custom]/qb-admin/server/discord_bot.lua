...
CommandCallbacks = {
    ...
    playerinfo = function(args)
        ...
        if not GetPlayerName(targetPlayer) then return SendDiscordMessage(Config.DiscordBot.UserName, "**ERROR:** Player is not connected.", Config.DiscordBot.EmbedColor) end
