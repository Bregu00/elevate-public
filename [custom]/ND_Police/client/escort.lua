...
exports('StopEscortPlayer', StopEscortPlayer)
...
exports.ox_target:addGlobalPlayer({
    ...
    },
    {
        ...
        canInteract = function(entity)
            ...
            return IsPedCuffed(entity) and not playerState.invBusy and nearbySeatVehicleCheck(ped) or targetState.dead and nearbySeatVehicleCheck(ped)
        end,
        onSelect = function(data)
