...
-- local function createNode(ammo, serial, item, coords, entity)
--     if entity then
...
-- local function startPedShooting(ammo, serial)
...
--         createNode(ammo, serial, 'projectile', endCoords)
--     elseif NetworkGetEntityIsNetworked(entityHit) then
--         createNode(ammo, serial, 'projectile', endCoords, entityHit)
--     end
...
--     if success then
--         createNode(ammo, serial, 'casing', vector3(coords.xy, impactZ))
--     end
...
--     return ammo and serial and startPedShooting(ammo, serial)
-- end)
